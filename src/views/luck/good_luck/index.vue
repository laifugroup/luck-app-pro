<template>
  <div class="container">
    <Breadcrumb :items="['menu.luck.luck', 'menu.luck.goodLuckList']" />
    <a-card class="general-card" :title="$t('menu.luck.goodLuckList')">
      <a-row>
        <a-col :flex="1">
          <a-form :model="formModel" :label-col-props="{ span: 6 }" :wrapper-col-props="{ span: 18 }" label-align="left">
            <a-row :gutter="16">
              ...
              <a-col :span="8">
                <a-form-item field="userId" :label="$t('goodLuck.form.userId')">
                  <a-input v-model="formModel.userId" :placeholder="$t('goodLuck.form.userId.placeholder')" />
                </a-form-item>
              </a-col>
              <a-col :span="8">
                <a-form-item field="userName" :label="$t('goodLuck.form.userName')">
...
const columns = computed<TableColumnData[]>(() => [
  ...
  {
    title: t("goodLuck.form.userId"),
    dataIndex: "userId",
    ellipsis: true,
    tooltip: true,
  },
  {
    title: t("goodLuck.form.userName"),
    dataIndex: "userName",
  },

  {
    title: t("goodLuck.form.firstName"),
    dataIndex: "firstName",
  },

  {
    title: t("goodLuck.form.groupId"),
    dataIndex: "groupId",
  },
  {
    title: t("goodLuck.form.credit"),
    dataIndex: "credit",
    render(data) {
      return (data.record.credit || '- ' ) +'U'
    },
  },
  {
...
const handleDetailView = (data: Resp) => {
  if (data.id !== undefined && data.id !== "") {
    router.push({ path: 'goodLuckView', query: { id: data.id } })
  }
}

const handleFormView = (data: Resp | undefined) => {
  router.push({ path: 'goodLuckForm', query: { id: data?.id } })
}
</script>
