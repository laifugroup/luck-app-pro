<template>
  <div class="container">
    <Breadcrumb :items="['menu.luck.user', 'menu.luck.luckUserList']" />
    <a-card class="general-card" :title="$t('menu.luck.luckUserList')">
      <a-row>
        <a-col :flex="1">
          <a-form :model="formModel" :label-col-props="{ span: 6 }" :wrapper-col-props="{ span: 18 }" label-align="left">
            <a-row :gutter="16">
              ...
              <a-col :span="8">
                <a-form-item field="userName" :label="$t('luckUser.form.userName')">
                  <a-input v-model="formModel.userName" :placeholder="$t('luckUser.form.userName.placeholder')" />
                </a-form-item>
              </a-col>
              <a-col :span="8">
                <a-form-item field="botUserId" :label="$t('luckUser.form.botUserId')">
                  <a-input v-model="formModel.botUserId" 
                  :placeholder="$t('luckUser.form.botUserId.placeholder')"
                    />
                </a-form-item>
              </a-col>
              <a-col :span="8">
                <a-form-item field="status" :label="$t('luckUser.form.status')">
                  <a-select v-model="formModel.status" :options="contentStatusOptions"
                    :placeholder="$t('luckUser.form.status.placeholder')" />
                </a-form-item>
              </a-col>
...
const columns = computed<TableColumnData[]>(() => [
  ...
  {
    title: t("luckUser.form.userName"),
    dataIndex: "userName",
    ellipsis: true,
    tooltip: true,
  },
  {
    title: t("luckUser.form.firstName"),
    dataIndex: "firstName",
  },

  {
    title: t("luckUser.form.botUserId"),
    dataIndex: "botUserId",
  },

  {
    title: t("luckUser.form.groupId"),
    dataIndex: "groupId",
  },
  {
...
const handleDetailView = (data: Resp) => {
  if (data.id !== undefined && data.id !== "") {
    router.push({ path: 'luckUserView', query: { id: data.id } })
  }
}

const handleFormView = (data: Resp | undefined) => {
  router.push({ path: 'luckUserForm', query: { id: data?.id } })
}
</script>
